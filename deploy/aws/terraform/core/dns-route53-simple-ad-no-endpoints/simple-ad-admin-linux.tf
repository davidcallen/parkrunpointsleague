module "simple-ad-admin-linux" {
  ...
  //  domain_name               = "adt-tradingapps.com"
  //  netbios_name              = "ADT-TRADINGAPPS"
  //  domain_join_user_name     = var.active_directory_domain_join_user_name
  //  domain_join_user_password = var.active_directory_domain_join_user_password    # TODO : move to Vault
  //  login_allowed_domain_groups = ["${var.org_short_name}-admin"]   # TODO : ideally can we get this from IAM in ta-backbone terraform state via outputs
