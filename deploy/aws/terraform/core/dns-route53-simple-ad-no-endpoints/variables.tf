...
variable "central_directory_admin_password_secret_allowed_iam_user_ids" {
  description = "The IAM User IDs allowed to read the Central Directory Administrator user password"
  type        = list(string)
  default     = []
}
