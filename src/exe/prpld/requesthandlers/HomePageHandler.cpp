...
void HomePageHandler::handleRequest(Poco::Net::HTTPServerRequest& request, Poco::Net::HTTPServerResponse& response)
{
	try
	{
		...
		responseStream << "<p>In February 2017 ParkRun <a href=\"https://www.parkrun.com/news/2016/11/25/points-league-announcement/\">turned off its Points League web pages</a>. </p>\n";
