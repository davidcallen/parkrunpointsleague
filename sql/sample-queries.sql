...
select count(*) from EVENT_RESULT_ITEM ERI, EVENT_RESULT ER WHERE ERI.EVENT_RESULT_ID = ER.ID AND ER.EVENT_ID = 2 and ER.RESULT_NUMBER = 53 ORDER BY EVENT_RESULT_ID DESC, POSITION ASC;
...
delete from EVENT_RESULT where ID=432;
delete from EVENT_RESULT where EVENT_ID = 2 AND RESULT_NUMBER=14;
delete from EVENT_RESULT_ITEM where EVENT_RESULT_ID = 395;
